...
const GAS_URL = 'https://script.google.com/macros/s/AKfycbzrBMVl4hR-4n8rVbXnrGLNlC-VDWy_F2lNGDiL0XVrKrxJ4fVZ_r9nxCGMJNW2SbY/exec';
const REFRESH_INTERVAL = 60000; // 60 วินาที
...
async function loadDashboard() {
  try {
    const res = await fetch(GAS_URL + '?action=getJobs&t=' + Date.now());
